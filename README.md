...
- Список поддерживаемых опций:
  ...
  - `-C | --colorless-mode` - включает безцветный режим вывода имен файлов.
...
- Исправить ошибку, при которой вывод одиночных файлов в тесте `FewArguments` выполняется без выравнивания
