...
- Исправить проблему в рассчете отступов. Она проявляет себя только в режиме одиночного файла

- 

- Сделать вывод \033[K идентичным `ls`

- Изменить аргумент функции `jls`. Она должна получать список файлов, выводить сначала информацию об одиночных файлах, а затем о директориях
