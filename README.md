...
- Сделать сортировку в `jlsSortFilesList()` идентичной сортировке из `ls`

- Добавить тест с аргументом ""

- Добавить тест с длинными именами файлов

- Добавить тест с длинными путями до файлов

- Добавить в тесты время работы программы. Для сравнения с `ls -l`
