...
- Добавить недостующие почты в @author

- Протестировать модуль color

- Проинтегрировать модуль color в jls

- Исправить проблему в функциях с snprintf: она добавляет \0 сама. К тому же, она возвращает int, а ответ он пишется уже как size_t
